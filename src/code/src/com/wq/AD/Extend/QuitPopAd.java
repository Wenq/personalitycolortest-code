...
public class QuitPopAd {
	...
	public void show(final Context context) {
		...
		dialog = new Dialog(context,
				android.R.style.Theme_Translucent_NoTitleBar);// 第二个样式参数,可根据自己应用或游戏中的布局进行设置
		...
		if (AppConnect.getInstance(context).hasPopAd(context)) {
						...
						.setPositiveButton("确定",
								new AlertDialog.OnClickListener() {
									...
									public void onClick(DialogInterface dialog,
										...
										((Activity) context).finish();// wq-只是关闭当前activity
									}
								})
			...
			new AlertDialog.Builder(context).setTitle("退出提示")
					.setMessage("确定要退出当前应用吗？")
